...
function Banner() {
  ...
  return (
    <>
      {bannerOpen && (
        <div className="mx-auto w-3/4 md:w-7/12 xl:w-5/12 fixed inset-x-0 bottom-2 md:bottom-4 z-60">
          <div className="bg-gray-900 text-slate-50 text-sm p-3 rounded shadow-lg flex justify-between">
            ...
            <button
              className="text-gray-200 hover:text-slate-400 pl-2 ml-3 border-gray-700"
